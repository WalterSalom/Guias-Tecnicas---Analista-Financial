...
public class StepDefinitions {
    ...
    public void heSearchForTheCourseFoundationExpressOnTheChoucairAcademyPlatform
        ...
        OnStage.theActorInTheSpotlight().attemptsTo(Search.the(academyChoucairData.get(0)
                .getStrCourse()));
    }
    ...
    public void heFindsTheCourseCalledResourcesFoundationExpress
            (List<AcademyChoucairData> academyChoucairData) throws Exception {
        OnStage.theActorInTheSpotlight().should(GivenWhenThen.seeThat(Answer.toThe(academyChoucairData.get(0)
                .getStrCourse())));
